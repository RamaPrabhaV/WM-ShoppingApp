...
import com.example.shopping.databinding.ActivityItemDetailBinding;

/**
 * Launcher activity of the application.
 * This is the only activity in the application. Products list and details will be loaded in the fragments in the activity.
 */
